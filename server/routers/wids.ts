/**
 * @domain   The Registry → Chain of Record → WID Issuance
 * @impl     Server Router — Witness ID generation, assignment, and verification procedures
 */
...
export const widsRouter = router({

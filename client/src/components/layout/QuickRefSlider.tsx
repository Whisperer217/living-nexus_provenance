            ...
            <div className="relative">
              ...
              <input
                ...
                style={{
                  ...
                  border: "1px solid oklch(0.18 0.05 285)",
                  color: "oklch(0.88 0.01 280)",
                }}
                onFocus={e => (e.currentTarget.style.borderColor = "oklch(0.80 0.145 82 / 0.5)")}
                onBlur={e => (e.currentTarget.style.borderColor = "oklch(0.18 0.05 285)")}
              />
            </div>
          </form>
        </div>
            ...
            <div className="space-y-2 flex-1">
              {[0, 1, 2, 4].map(i => (
                <div key={i} className="flex items-center gap-2 animate-pulse">
                  <div className="w-8 h-8 rounded flex-shrink-0" style={{ background: "oklch(0.13 0.035 285)" }} />
                  <div className="flex-1 space-y-1">
                    <div className="h-2 rounded" style={{ background: "oklch(0.13 0.035 285)", width: "70%" }} />
                ...
                >
                  {(track.coverArtUrl ?? track.song?.coverArtUrl) ? (
                    ...
                    <div className="w-8 h-8 rounded flex-shrink-0 flex items-center justify-center text-sm"
                      style={{ background: "oklch(0.14 0.045 285)" }}>
                      🎵
                    </div>
                  )}

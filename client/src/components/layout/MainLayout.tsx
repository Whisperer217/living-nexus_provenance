                ...
                >
                  <div className="relative flex-shrink-0">
                    ...
                    {user?.licenseStatus === "licensed" && (
                      <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full flex items-center justify-center" style={{ background: "#8A6A2A" }}>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {user?.licenseStatus === "licensed" ? (
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <Fingerprint size={10} style={{ color: "#8A6A2A" }} />
                        <span className="text-[10px] font-heading tracking-wider" style={{ color: "#8A6A2A" }}>WITNESSED</span>
                      </div>
                    ) : (

  ...
  if (!versions || versions.length === 0) {
    return (
      <div
        ...
        style={{ background: "oklch(0.10 0.03 270 / 0.6)", border: "1px dashed #4A2D52" }}
      >
    ...
    <div className="mt-3 space-y-2">
      {versions.map((v: any) => (
        <div
          ...
          style={{ background: "oklch(0.10 0.03 270 / 0.6)", border: "1px solid #3D2440" }}
        >
          <div
    ...
    <div className="mt-3">
      ...
      {items.length === 0 ? (
        <div
          ...
          style={{ background: "oklch(0.10 0.03 270 / 0.5)", border: "1px dashed #4A2D52" }}
        >
          <p className="text-[11px]" style={{ color: "oklch(0.5 0.03 280)" }}>
    ...
    <div className="space-y-3">
      ...
      {(!playlists || playlists.length === 0) && (
        <div
          ...
          style={{ background: "oklch(0.10 0.03 270 / 0.5)", border: "1px dashed #3D2440" }}
        >
      ...
      {playlists?.map((pl: any) => {
        ...
        return (
          <div
            ...
            style={{ border: `1px solid ${isExpanded ? "oklch(0.65 0.2 300 / 0.3)" : "#3D2440"}` }}
          >
            {/* Header row */}
            <div

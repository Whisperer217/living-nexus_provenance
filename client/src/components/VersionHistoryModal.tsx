              ...
              >
                ...
                <div>
                  ...
                  <div
                    ...
                    style={{ background: "oklch(0.24 0.015 200)", border: "1px dashed oklch(0.84 0.155 85 / 0.3)" }}
                ...
                <div className="space-y-1">
                  ...
                  <Select value={aiDisclosure} onValueChange={(v) => setAiDisclosure(v as any)}>
                    ...
                    <SelectContent style={{ background: "#2C3438", border: "1px solid oklch(0.84 0.155 85 / 0.2)" }}>
                ...
                <Button
                  ...
                  className="w-full"
                  style={{ background: "oklch(0.84 0.155 85)", color: "#2C3438", fontFamily: "'Cinzel', serif", fontWeight: 700 }}
                >
                  {uploading ? (

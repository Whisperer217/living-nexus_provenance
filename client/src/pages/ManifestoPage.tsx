  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto px-6 py-20 text-center">
          ...
          <p
            ...
            style={{ color: "#AA8E64", fontFamily: "'Inter', sans-serif" }}
          >
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-base leading-relaxed mb-16" style={{ color: "#DACAAA" }}>
            ...
            return (
              <div key={i} className="flex gap-5">
                <div
                  ...
                  style={{ background: "rgba(203,177,131,0.10)", border: "1px solid rgba(203,177,131,0.22)" }}
                >
                  <Icon size={18} style={{ color: "#CBB183" }} />
                </div>
                <div>
                  <h2
                  ...
                  <p className="text-base leading-relaxed" style={{ color: "#AA8E64" }}>
                    {tenet.body}
                  </p>
                </div>
              </div>
        ...
        <div
          ...
          style={{ background: "linear-gradient(90deg, transparent, rgba(203,177,131,0.28), transparent)" }}
        />
        ...
        <div
          ...
          style={{
            background: "#2C3438",
            border: "1px solid rgba(203,177,131,0.12)",
          }}
        >
          <h2
          ...
          <p className="text-base leading-relaxed mb-6 max-w-lg mx-auto" style={{ color: "#AA8E64" }}>
        ...
        <div
          ...
          style={{
            background: "#2C3438",
            border: "1px solid rgba(203,177,131,0.1)",
          }}
        >
          <div
            className="w-px h-10 mx-auto mb-6"
            style={{ background: "linear-gradient(180deg, transparent, rgba(203,177,131,0.45))" }}
          />
          <p
          ...
          <div
            ...
            style={{ background: "linear-gradient(180deg, rgba(203,177,131,0.45), transparent)" }}
          />
        </div>

  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto px-6 py-20 text-center">
          ...
          <p
            ...
            style={{ color: "var(--ln-smoke)", fontFamily: "'Inter', sans-serif" }}
          >
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-base leading-relaxed mb-16" style={{ color: "var(--ln-parchment)" }}>
          ...
          {TENETS.map((tenet, i) => {
            ...
            return (
              <div key={i} className="flex gap-5">
                ...
                >
                  <Icon size={18} style={{ color: "var(--ln-gold)" }} />
                </div>
                <div>
                  <h2
                  ...
                  <p className="text-base leading-relaxed" style={{ color: "var(--ln-smoke)" }}>
                    {tenet.body}
                  </p>
                </div>
              </div>
        ...
        <div
          ...
          style={{ background: "linear-gradient(90deg, transparent, rgba(196,154,40,0.25), transparent)" }}
        />
        ...
        >
          ...
          <p className="text-base leading-relaxed mb-6 max-w-lg mx-auto" style={{ color: "var(--ln-smoke)" }}>
        ...
        <div
          ...
          style={{
            background: "var(--ln-coal)",
            border: "1px solid rgba(196,154,40,0.09)",
          }}
        >
          <div
            className="w-px h-10 mx-auto mb-6"
            style={{ background: "linear-gradient(180deg, transparent, rgba(196,154,40,0.4))" }}
          />
          <p
          ...
          <div
            ...
            style={{ background: "linear-gradient(180deg, rgba(196,154,40,0.4), transparent)" }}
          />
        </div>
            ...
            >
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  <li key={line} className="flex items-start gap-2 text-sm" style={{ color: "var(--ln-parchment)" }}>
                    <span style={{ color: "var(--ln-gold)" }} className="mt-0.5 flex-shrink-0">✓</span>
                    {line}
                  </li>
                ))}
              </ul>

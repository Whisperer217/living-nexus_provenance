...
function Field({ icon: Icon, label, children }: { icon: React.ElementType; label: string; children: React.ReactNode }) {
  return (
    <div className="rounded-xl p-4" style={{ background: "oklch(0.09 0.01 280)", border: "1px solid #8A6A2A" }}>
...
<style>
  ...
  .wid { font-family: 'Orbitron', monospace; color: #8A6A2A; font-size: 18px; letter-spacing: 3px; }
...
<div class="cert">
  ...
  <div class="value" style="font-size:18px;color:#8A6A2A;">${data.title}</div>
...
export default function VerifyPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#1E1020" }}>
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-12">
        <div className="w-full max-w-xl">
          ...
          {!queryWid && (
            <div className="text-center py-12 rounded-2xl" style={{ background: "oklch(0.125 0.028 52)", border: "1px solid #8A6A2A" }}>

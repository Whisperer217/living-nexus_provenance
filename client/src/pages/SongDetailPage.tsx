...
export default function SongDetailPage() {
  ...
  return (
    <div className="min-h-screen pb-8" style={{ background: "#2D1B2E" }}>
      <Helmet>
              ...
              <div className="relative w-full sm:w-56 flex-shrink-0">
                ...
                {(song as any).videoUrl && (
                  <div
                    ...
                    style={{ aspectRatio: "16/9", background: "#2D1B2E" }}
                  >
                    {showVideo ? (
                      <video
                        ref={videoDetailRef}
                      ...
                      >
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity">
                          <div className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold"
                            style={{ background: "oklch(0.84 0.155 85)", color: "#2D1B2E" }}>
          ...
          {transformPhase === "idle" && (
            <div className="space-y-4 py-2">
              ...
              <Button
                ...
                style={{ background: "oklch(0.65 0.2 300)", color: "#2D1B2E", fontFamily: "'Orbitron', sans-serif", letterSpacing: "0.08em" }}
              >

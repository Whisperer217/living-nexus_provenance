  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${card.audioStatus === "done" ? "oklch(0.65 0.18 160 / 0.5)" : "#8A6A2A"}`,
      }}
    >
      {/* Card header */}
      <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_140px] gap-4">
            ...
            <div className="space-y-3">
              ...
              <div
                ...
                style={{
                  ...
                  border: `1.5px dashed ${card.audioDragging
                    ...
                    : card.audioFile ? "oklch(0.65 0.18 160 / 0.5)" : "#3D2440"}`,
                }}
              >
                <input
                  ref={audioInputRef}
              ...
              <Input
                ...
                style={{ background: "oklch(0.09 0.03 270)", border: "1px solid #8A6A2A", color: "#FFFFFF" }}
              />
              ...
              <div className="grid grid-cols-2 gap-2">
                <Select value={card.genre} onValueChange={v => onChange(card.id, { genre: v })}>
                  ...
                  <SelectContent style={{ background: "oklch(0.14 0.015 280)", border: "1px solid #8A6A2A" }}>
                    {GENRES.map(g => (
              ...
              <div
                ...
                style={{
                  ...
                  border: `1.5px dashed ${card.coverDragging
                    ? "oklch(0.84 0.155 85 / 0.7)"
                    : card.coverPreview ? "oklch(0.65 0.18 160 / 0.4)" : "#3D2440"}`,
                }}
              >
                <input
                  ref={coverInputRef}
  ...
  if (collectionResult) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="rounded-2xl p-6 space-y-4" style={{ background: "oklch(0.125 0.028 52)", border: "1px solid #8A6A2A" }}>
          <div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Button
            ...
            variant="outline"
            className="flex-1 gap-2"
            style={{ border: "1px solid #3D2440", color: "oklch(0.6 0.04 280)" }}
          >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "oklch(0.125 0.028 52)", border: "1px solid #8A6A2A" }}
      >
        <p className="text-[10px] font-heading tracking-widest uppercase" style={{ color: "oklch(0.72 0.04 280)" }}>
          Collection / Album
        </p>
        <div className="grid grid-cols-1 md:grid-cols-[1fr_120px] gap-3">
          ...
          <div
            ...
            style={{
              ...
              border: `1.5px dashed ${albumCoverPreview ? "oklch(0.65 0.18 160 / 0.4)" : "#3D2440"}`,
            }}
          >
            <input
              ref={albumCoverRef}
      ...
      >
        ...
        {batchFillOpen && (
          <div className="px-4 pb-4 space-y-3 border-t" style={{ borderColor: "#8A6A2A" }}>
      ...
      >
        ...
        <Button
          ...
          style={{
            background: readyCount > 0 && albumName.trim() ? "oklch(0.84 0.155 85)" : "#3D2440",

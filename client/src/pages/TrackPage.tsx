    ...
    <div className="max-w-2xl mx-auto px-4 py-4 animate-fade-up">
      ...
      <div className="rounded-2xl overflow-hidden border border-white/[0.08] mb-5">
        ...
        <div className="relative h-[220px] flex items-center justify-center"
          style={{ background: track.bg || "linear-gradient(135deg, oklch(0.125 0.028 52), oklch(0.158 0.030 50))" }}>
          {track.artUrl ? (
          ...
          <button
            ...
            className="absolute bottom-4 left-4 w-12 h-12 rounded-full flex items-center justify-center
              bg-[#8A6A2A] hover:bg-[#8A6A2A]/90 active:scale-95 transition-all shadow-lg shadow-[#8A6A2A]/20"
          >
            {isPlaying
        ...
        <div className="p-4 bg-[oklch(0.12_0.012_280)]">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={copyLink}
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-[12px] font-body transition-all border
                bg-white/[0.04] border-white/[0.08] text-white/40 hover:border-[#8A6A2A]/30 hover:text-[#8A6A2A]"
            >
      ...
      {/* ── Gift Jar ── */}
      <div className={`rounded-2xl border p-5 mb-5 ${tipsEnabled ? "border-[#8A6A2A]/20 bg-[oklch(0.11_0.012_280)]" : "border-white/[0.06] bg-[oklch(0.10_0.008_280)]"}`}>
        <div className="flex items-center gap-2 mb-2">
          <DollarSign size={15} className={tipsEnabled ? "text-[#8A6A2A]" : "text-white/20"} />
          <span className={`font-heading text-[13px] tracking-wider ${tipsEnabled ? "text-[#8A6A2A]" : "text-white/25"}`}>
            Tip the Artist
          </span>
          {tipTotal > 0 && (
              ...
              {TIP_AMOUNTS.map(amt => (
                <button
                  ...
                  className={`py-2 rounded-xl text-[12px] font-heading transition-all border
                    ${tipSelected === amt
                      ? "bg-[#8A6A2A]/15 border-[#8A6A2A] text-[#8A6A2A]"
                      : "bg-[oklch(0.14_0.013_280)] border-white/[0.08] text-white/45 hover:border-[#8A6A2A]/40 hover:text-[#8A6A2A]"
                    }`}
                >
                  ${amt}
                </button>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-xl text-[12px] font-body text-white/70
                  ...
                  focus:border-[#8A6A2A]/50 placeholder:text-white/60"
              />
              <button
                onClick={sendTip}
                className="px-4 py-2 rounded-xl font-heading text-[12px] tracking-wider transition-all
                  bg-[#8A6A2A]/10 border border-[#8A6A2A]/30 text-[#8A6A2A]
                  hover:bg-[#8A6A2A]/20 hover:border-[#8A6A2A]/60 active:scale-[0.98]"
              >
                Send ✦
              </button>
            </div>

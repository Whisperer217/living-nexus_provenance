      ...
      <div className="container py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div key={label} className="rounded-xl p-4" style={{ background: "oklch(0.10 0.055 280)", border: "1px solid oklch(0.2 0.015 280)" }}>
        ...
        {/* Tab Navigation */}
        <div className="flex gap-1 mb-6 p-1 rounded-xl w-fit" style={{ background: "oklch(0.10 0.055 280)", border: "1px solid oklch(0.2 0.015 280)" }}>
          <button
        ...
        {activeTab === "songs" && (
          <div>
            ...
            {!songs?.length ? (
              <div className="text-center py-16 rounded-xl" style={{ background: "oklch(0.10 0.055 280)", border: "1px dashed oklch(0.25 0.02 280)" }}>
              ...
              <div className="space-y-2">
                {songs.map((song: any, idx: number) => (
                  <div key={song.id} className="flex items-center gap-4 p-3 rounded-xl" style={{ background: "oklch(0.10 0.055 280)", border: "1px solid oklch(0.18 0.015 280)" }}>
            ...
            {!transforms?.length ? (
              ...
              <div className="space-y-3">
                {transforms.map((t: any) => {
                  ...
                  return (
                    <div key={t.id} className="rounded-xl p-4" style={{ background: "oklch(0.10 0.055 280)", border: "1px solid oklch(0.18 0.015 280)" }}>

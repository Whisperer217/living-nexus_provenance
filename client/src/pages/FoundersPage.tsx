...
import { Shield, Star, Lock, ChevronLeft, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#080d14] text-white">
      ...
      <div className="max-w-lg mx-auto px-4 pt-6">
        <button
          onClick={() => navigate("/")}
          className="flex items-center gap-1.5 text-gray-500 hover:text-gray-300 text-sm transition-colors mb-8"
        >
          <ChevronLeft size={16} />
      ...
      <div className="max-w-lg mx-auto px-4 pb-16">
        ...
        <div className="text-center mb-10">
          <p className="text-[#c9a84c] text-xs uppercase tracking-widest mb-3">Living Nexus</p>

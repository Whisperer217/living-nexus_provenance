        ...
        return (
          <div className="space-y-6">
            ...
            <div className="flex justify-end pt-4">
              <Button onClick={() => { if (!lyrics.trim()) { toast.error("Write some lyrics first"); return; } setStep("metadata"); }} disabled={!lyrics.trim()} className="gap-2" style={{ background: atmosphere.colorPrimary, color: "#111009" }}>

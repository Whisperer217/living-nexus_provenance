...
export const ATMOSPHERES: Record<ManifestationType, ManifestationAtmosphere> = {
  ...
  music: {
    ...
    icon: "♪",
    colorPrimary: "#C49A28",
    colorGlow: "rgba(196,154,40,0.35)",
    colorBg: "rgba(196,154,40,0.06)",
    colorBorder: "rgba(196,154,40,0.28)",
    gradient: "linear-gradient(135deg, rgba(196,154,40,0.12) 0%, rgba(196,154,40,0.04) 50%, rgba(0,0,0,0.06) 100%)",
    language: {

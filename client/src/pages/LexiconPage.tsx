...
const CATEGORY_COLORS: Record<LexiconEntry["category"], string> = {
  identity: "var(--ln-gold)",    // gold
  action: "var(--ln-seal-bright)",     // teal
  record: "var(--ln-gold)",     // indigo
  space: "var(--ln-gold)",      // violet
  economy: "var(--ln-seal-bright)",    // sage
};
    ...
    <div className="min-h-screen" style={{ background: "var(--ln-coal)" }}>
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <p className="text-base leading-relaxed max-w-xl mx-auto" style={{ color: "var(--ln-smoke)" }}>
      ...
      <div className="max-w-3xl mx-auto px-6 pt-12 pb-4">
        <blockquote
          ...
          style={{ color: "var(--ln-smoke)", borderLeft: "none" }}
        >
          "Words have power. Power has meaning. Meaning is what changes the internal state of the witness."
        </blockquote>
        <p className="text-center text-xs mt-2" style={{ color: "var(--ln-iron)" }}>— Command Domains LLC</p>
      </div>
                    ...
                    <div className="flex items-center gap-3 min-w-0 sm:w-72 flex-shrink-0">
                      <div className="text-center">
                        ...
                        <p
                          ...
                          style={{ color: "var(--ln-iron)", textDecorationColor: "rgba(63,74,80,0.5)" }}
                        >
                          {entry.standard}
                        </p>
                      </div>
                      <ArrowRight className="w-4 h-4 flex-shrink-0" style={{ color: "var(--ln-iron)" }} />
                      <div className="text-center">
                        <p
                          className="text-xs font-medium tracking-wide uppercase mb-0.5"
                          style={{ color }}
      ...
      >
        <div className="max-w-xl mx-auto">
          <p className="text-base mb-6" style={{ color: "var(--ln-smoke)" }}>
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-xs" style={{ color: "var(--ln-iron)" }}>

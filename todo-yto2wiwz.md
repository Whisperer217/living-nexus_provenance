...
- [ ] Diagnose reported failure of `https://discord.gg/dqCmTY5Ucb` from Home/navigation: verify the currently published source versus unmerged PR #18, inspect the invite response without changing Discord configuration, identify the failing layer, and apply only an authorized corrective action.

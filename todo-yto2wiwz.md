...
- [ ] Produce the Cartography Directive deliverable before further implementation: establish a source-verified map of codebase truth, doctrine, ethics, registry mechanics, public claim boundaries, legal/regulatory research, comparative systems, architecture findings, and sequenced recommendations. Record issues as findings only; do not implement corrective product changes without subsequent authorization.
- [ ] Apply the Legal Review Boundary throughout the Cartography Directive: separately map Doctrine, Technical Fact, Creator Declaration, independently verifiable Evidence, and Legal Claim; mark every legal conclusion unresolved or requiring qualified counsel until review; preserve doctrine and law without forcing either to fit the other.

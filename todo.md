...
## Phase 38: Lyrics-Only Registration
- [x] isLyricsOnly field added to schema and migrated (pnpm db:push applied)
- [x] songs.upload tRPC procedure already had mode: 'lyrics' support, lyricsHash storage, isLyricsOnly flag
- [x] Updated UploadPage: Upload Audio / Protect Lyrics Only toggle at top of Step 1
- [x] Lyrics mode: large textarea replaces audio dropzone; WID generation hashes lyrics text via SHA-256
- [x] Step 3 shows Lyrics-Only Mode info banner; Step 4 shows LYRICS PROTECTED badge + Lyrics Hash row
- [x] SongDetailPage: LYRICS PROTECTED badge in lyrics section header
- [x] WID certificate block appended at bottom of lyrics (WID, Creator, Title, Date, Lyrics Hash, Verify URL)
- [x] oncopy event on lyrics div: auto-appends WID attribution to any copied text (even partial selections)
- [x] TypeScript: 0 errors | Vitest: 4/4 passing

...
export const users = mysqlTable("users", {
  ...
  // generatedTagline: legacy one-liner (kept for backward compat, superseded by identitySnapshot)
  generatedTagline: text("generatedTagline"),
  generatedTaglineAt: timestamp("generatedTaglineAt"),
  // identitySnapshot: multi-paragraph Living Identity Snapshot generated from the full creative corpus.
  // Analyzes ALL content types (music, books, comics, testimony, visual, games, lyrics, manuscripts).
  // Regenerated when corpusFingerprint changes (new medium type or ≥5 new published works).
  identitySnapshot: text("identitySnapshot"),
  identitySnapshotAt: timestamp("identitySnapshotAt"),
  // corpusFingerprint: compact hash of {publishedCount}:{mediumSet} used to detect stale snapshots.
  // Format: "246:audio,comic,manuscript,lyrics" — changes trigger regeneration.
  corpusFingerprint: varchar("corpusFingerprint", { length: 256 }),
});
